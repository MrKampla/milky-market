...
import { createBlockchainExplorerLinkGenerator } from '../utils/hooks/useBlockchainExplorerLinkGenerator';
    ...
    <Flex mt={2} w="full" alignItems="center" justify="flex-end">
      ...
      <chakra.a
        href={
          linkGenerator({
            // hardcoded for now
            address: getMilkyMarketContractAddresses(chain.polygonMumbai.id).milkyMarket,
            type: 'address',
          }) + '#code'
        }
        target="_blank"
      ...
      >
        <Icon boxSize="5" viewBox="0 0 38.4 33.5" fill="currentColor">
          <path
